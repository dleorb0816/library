...
<header>
		...
		<nav role="navigation">
			<ul id="main-menu">
				<li><a href="/use/time">도서관이용</a>
				<ul id="sub-menu">
						<li><a href="/use/time">이용시간/휴관일</a></li>
						<li><a href="/use/usebook">대출/반납/예약안내</a></li>
						<li><a href="/use/uselibrary">도서관이용안내</a></li>
						<li><a href="/use/video">영장정보처리방침</a></li>
					</ul>
				</li>
				<li><a href="#">도서관서비스</a>
					<ul id="sub-menu">
